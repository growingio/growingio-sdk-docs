...
抖音原生 SDK 下载：[https://assets.giocdn.com/sdk/minip/4.4.0/gio-bytedance.js](https://assets.giocdn.com/sdk/minip/4.4.0/gio-bytedance.js)<br/>
...
uniapp 框架 SDK 下载：[https://assets.giocdn.com/sdk/minip/4.4.0/gio-uniapp.js](https://assets.giocdn.com/sdk/minip/4.4.0/gio-uniapp.js)<br/>
**<font size="2">(如果您点击链接在浏览器中直接打开了文件并不是下载文件，请尝试右键点击链接，选择 `链接存储为...` 即可正常触发下载)</font>**
...
Taro 框架 SDK 下载：[https://assets.giocdn.com/sdk/minip/4.4.0/gio-taro.js](https://assets.giocdn.com/sdk/minip/4.4.0/gio-taro.js)<br/>
**<font size="2">(如果您点击链接在浏览器中直接打开了文件并不是下载文件，请尝试右键点击链接，选择 `链接存储为...` 即可正常触发下载)</font>**
