...
微信原生 SDK 下载：<https://assets.giocdn.com/sdk/minip/cdp/3.8.18/gio-wechat.js><br/>
...
WePY2 框架 SDK 下载：<https://assets.giocdn.com/sdk/minip/cdp/3.8.18/gio-wepy.js><br/>
**<font size="2">(如果您点击链接在浏览器中直接打开了文件并不是下载文件，请尝试右键点击链接，选择 `链接存储为...` 即可正常触发下载)</font>**
...
Remax 框架 SDK 下载：<https://assets.giocdn.com/sdk/minip/cdp/3.8.18/gio-remax.js><br/>
**<font size="2">(如果您点击链接在浏览器中直接打开了文件并不是下载文件，请尝试右键点击链接，选择 `链接存储为...` 即可正常触发下载)</font>**
