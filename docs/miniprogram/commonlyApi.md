...
| `properties`      | `Object` | 选填；事件属性，当事件属性关联有维度表时，属性值为对应的维度表模型ID(记录ID)[参数限制](/docs/miniprogram/commonlyApi#object参数限制) |
...
| 参数             | 参数类型 | 说明                                                                                        |
|------------------|----------|-------------------------------------------------------------------------------------------|
| `userAttributes` | `Object` | 包含登录用户属性的 Object 对象。[参数限制](/docs/miniprogram/commonlyApi#object参数限制) |
...
**<font color="#FC5F3A">注意：</font>**<br/>
**1）SDK版本>=3.8.12支持 且 OP平台版本>=4.0支持。**<br/>
