...
在4.0版本中，我们放弃了对 **`Wepy`**、**`mpvue`**（v4.6.0 已重新支持，作为微信小程序下的框架集成）、**`Chameleon`** 框架的支持，因为他们已经过时或被开发者放弃。如果您使用了以上框架（mpvue 除外），请尝试迁移小程序的框架；mpvue 用户可直接升级至 v4.6.0 并按[微信小程序集成文档](/docs/miniprogram/integration/wechat)中的 mpvue 标签重新集成。
...
6. 修改 **`keepAlive`** 配置项传参，老版本的传参是以毫秒为单位，新版本使用分钟为单位，请注意换算修改。未使用则忽略。
...
在4.0版本中，我们放弃了对 **`Wepy`**、**`mpvue`**（v4.6.0 已重新支持，作为微信小程序下的框架集成）、**`Chameleon`**、**`Remax`** 框架的支持，因为他们已经过时或被开发者放弃。如果您使用了以上框架（mpvue 除外），请尝试迁移小程序的框架；mpvue 用户可直接升级至 v4.6.0 并按[微信小程序集成文档](/docs/miniprogram/integration/wechat)中的 mpvue 标签重新集成。
...
2. 修改 **`keepAlive`** 配置项传参，老版本的传参是以毫秒为单位，新版本使用分钟为单位，请注意换算修改。未使用则忽略。
