...
buildscript {
    ...
    dependencies {
        ...
        classpath 'com.growingio.android:autotracker-gradle-plugin:3.5.3'
    }
}
...
dependencies {
    implementation 'com.growingio.android:autotracker-cdp:3.5.3'
}
```
...
dependencies {
    //GrowingIO 埋点 SDK
    implementation 'com.growingio.android:tracker-cdp:3.5.3'
}
```
