...
* 引入SDK `implementation 'com.growingio.android:autotracker-cdp:4.2.0'` 变更为 `implementation 'com.growingio.android:autotracker:4.2.0'`；
...
dependencies {
    implementation 'com.growingio.android:autotracker-saas:4.2.0'
}
```
