...
```groovy
...
implementation "com.growingio.android:hybrid:3.3.4"
```
...
```groovy
...
implementation "com.growingio.android:encoder:3.3.4"
```
...
```groovy
...
implementation "com.growingio.android:protobuf:3.3.4"
```
