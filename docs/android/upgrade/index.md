...
* 引入SDK `implementation 'com.growingio.android:autotracker-cdp:4.5.2'` 变更为 `implementation 'com.growingio.android:autotracker:4.5.2'`；
...
dependencies {
    implementation 'com.growingio.android:autotracker-saas:4.5.2'
}
```
