...
**A：**AccountID、DataSourceID需要在CDP增长平台上新建数据源，或从已知应用中获取, 如不清楚或无权限请联系项目经理；操作步骤参考[帮助文档](/docs/android/base/Getting%20Started#集成准备)。
...
**A：** 
发送数据策略：<br/>
Web 和小程序基本上实时发送采集数据<br/>
iOS 和Android：以每隔默认时间15秒的情况下向服务器发送事件包（最大50条事件）<br/>
发送失败处理策略：<br/>
